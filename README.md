...
2. **Instalação**:
   ...
   - Coloque o arquivo `PlayEncantamento-10.2.1.jar` na pasta `plugins/` do seu servidor.
...
A versão atual é **10.2.1** e usa Java 21. Para compilar de forma reproduzível, execute `./mvnw -B clean verify`.
